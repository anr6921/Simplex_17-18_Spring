...
{
	std::vector<vector3> lPos;

	lPos.push_back(vector3(0, 0, 0)); //0
	lPos.push_back(vector3(5, 0, 0)); //1
	lPos.push_back(vector3(5, 5, 0)); //2
	lPos.push_back(vector3(0, 5, 0)); //3

	lPos.push_back(vector3(0, 0, 5)); //4
	lPos.push_back(vector3(5, 0, 5)); //5
	lPos.push_back(vector3(5, 5, 5)); //6
	lPos.push_back(vector3(0, 5, 5)); //7

	//front
	AddVertexPosition(lPos[4]);
	AddVertexPosition(lPos[5]);
	AddVertexPosition(lPos[6]);
